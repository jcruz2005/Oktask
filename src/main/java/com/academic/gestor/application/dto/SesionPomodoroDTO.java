...
/**
 * DTO de salida para representar una sesión de Pomodoro.
 *
 * @param id identificador único
 * @param tareaId ID de la tarea asociada
 * @param tituloTarea título de la tarea asociada (para presentación)
 * @param materiaId ID de la materia asociada
 * @param nombreMateria nombre de la materia asociada (para presentación)
